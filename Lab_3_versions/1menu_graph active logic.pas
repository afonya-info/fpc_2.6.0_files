...
begin
  ...
  b3 := b;
  n1 := n;
  while (a3 < -40) or (n1 > 100) or (b3>50)
  begin
    clrscr;
    textcolor(10);
    writeln('To work witn graphik mode input left limit>-40 and amount of splits must be <100');
    writeln('Press enter nex repeat input');
    normvideo;
    readln();
    enterborders;
  end
